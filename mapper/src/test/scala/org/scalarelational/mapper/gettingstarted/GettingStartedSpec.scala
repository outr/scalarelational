  ...
  "H2 examples" should {
    ...
    "Insert some Suppliers" in {
      ...
      session {
        ...
        acmeId = insert(name("Acme, Inc."), street("99 Market Street"), city("Groundsville"), state(Some("CA")), zip("95199")).result
        superiorCoffeeId = insert(name("Superior Coffee"), street("1 Party Place"), city("Mendocino"), zip("95460")).result

        // Short-hand when using values in order - we exclude the id since it will be generated by the database
        theHighGroundId = insertInto(suppliers, "The High Ground", "100 Coffee Lane", "Meadows", Some("CA"), "93966").result
      }
    }
  ...
  "Mapper Examples" should {
    ...
    "Query a Supplier back" in {
      session {
        ...
        starbucks should equal(Supplier("Starbucks", "123 Everywhere Rd.", "Lotsaplaces", Some("CA"), "93966", Some(4)))
      }
    }
    "Query a Supplier back as a tuple" in {
      session {
        ...
        starbucksTuple should equal(("Starbucks", "123 Everywhere Rd.", "Lotsaplaces", Some("CA"), "93966", Some(4)))
    ...
    "Query 'French Roast' with 'Superior Coffee' for (Coffee, Supplier)" in {
      session {
        ...
        superior should equal(Supplier("Superior Coffee", "1 Party Place", "Mendocino", None, "95460", Some(2)))
      }
    }
  }
}
...
case class Supplier(name: String, street: String, city: String, state: Option[String], zip: String, id: Option[Int] = None)
