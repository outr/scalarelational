...
case class SixExpressions[T1, T2, T3, T4, T5, T6](e1: SE[T1],
                                                  e2: SE[T2],
                                                  e3: SE[T3],
                                                  e4: SE[T4],
                                                  e5: SE[T5],
                                                  e6: SE[T6]) extends SelectExpressions[(T1, T2, T3, T4, T5, T6)] {
  lazy val vector = Vector(e1, e2, e3, e4, e5, e6)
}

case class SevenExpressions[T1, T2, T3, T4, T5, T6, T7](e1: SE[T1],
                                                        e2: SE[T2],
                                                        e3: SE[T3],
                                                        e4: SE[T4],
                                                        e5: SE[T5],
                                                        e6: SE[T6],
                                                        e7: SE[T7]) extends SelectExpressions[(T1, T2, T3, T4, T5, T6, T7)] {
  lazy val vector = Vector(e1, e2, e3, e4, e5, e6, e7)
}

case class EightExpressions[T1, T2, T3, T4, T5, T6, T7, T8](e1: SE[T1],
                                                            e2: SE[T2],
                                                            e3: SE[T3],
                                                            e4: SE[T4],
                                                            e5: SE[T5],
                                                            ...
                                                            e7: SE[T7],
                                                            e8: SE[T8]
                                                           ) extends SelectExpressions[(T1, T2, T3, T4, T5, T6, T7, T8)] {
  lazy val vector = Vector(e1, e2, e3, e4, e5, e6, e7, e8)
}

case class NineExpressions[T1, T2, T3, T4, T5, T6, T7, T8, T9](e1: SE[T1],
                                                               e2: SE[T2],
                                                               e3: SE[T3],
                                                               e4: SE[T4],
                                                               e5: SE[T5],
                                                               ...
                                                               e8: SE[T8],
                                                               e9: SE[T9]
                                                              ) extends SelectExpressions[(T1, T2, T3, T4, T5, T6, T7, T8, T9)] {
  lazy val vector = Vector(e1, e2, e3, e4, e5, e6, e7, e8, e9)
}

case class TenExpressions[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10](e1: SE[T1],
                                                                   e2: SE[T2],
                                                                   e3: SE[T3],
                                                                   e4: SE[T4],
                                                                   e5: SE[T5],
                                                                   ...
                                                                   e9: SE[T9],
                                                                   e10: SE[T10]
                                                                  ) extends SelectExpressions[(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)] {
